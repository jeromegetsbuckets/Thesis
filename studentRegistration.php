...
<head>
	<title>PLTCI Registration</title>
			...
			<ul class="nav navbar-nav">
				...
				<li class="active" class="dropdown" >
					...
					<ul class="dropdown-menu forAnimate" role="menu">
						...
						<li class="active"><a href="studentRegistration.php">Student</a></li>
					</ul>
			</ul>
		</div>
	</div>
		...
		<div class="row">
			<div class="card card-container">
				<div class="panel panel-primary">
					<div class="panel-heading" style="text-align:center;font-weight:bold;font-size:1.125em;">Student Registration</div>
						<div class="panel-body">
						<form class="form-signin" method="POST" action="processBorrowerRegister.php">
							...
							<input type="text" name="username" class="form-control input-lg" placeholder="Student no" Autofocus Required><br>
							<input type="password" name="password" class="form-control input-lg" placeholder="Password"  Required><br>
							<input type="text" name="course" class="form-control input-lg" placeholder="Course" Required><br>
							<input type="text" name="yrlevel" class="form-control input-lg" placeholder="Year Level" Required><br>
							<div align="center"><b style="color:red;">
							<?php // php here
