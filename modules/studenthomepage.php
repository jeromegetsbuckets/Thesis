	...
	<div class="container">
		...
		<div class="container"><br />
			...
			<div class="pull-right" style="padding-top:30px;">
					<b>Welcome. to the summoners rift!</b><abbr title="Settings"><a href="#"><span style="font-size:16px; padding:0px 10px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-cog"></span></a></abbr>
			</div>
		</div>
	</div>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="library1.jpg" alt="Pltci" style="width:100%;">
      ...
      <div class="item">
        <img src="library2.jpg" alt="Library" style="width:100%;">
        <div class="carousel-caption">
          <h3></h3>
          <p></p>
        </div>
      ...
      <div class="item">
        <img src="library3.jpg" alt="school" style="width:100%;">
        <div class="carousel-caption">
          <h3></h3>
          <p></p>
        </div>
